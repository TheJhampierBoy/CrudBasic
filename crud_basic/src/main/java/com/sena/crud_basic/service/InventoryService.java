...
public class InventoryService {
    ...
    public responseDTO save(InventoryDTO inventoryDTO) {
        ...
        return new responseDTO("success", "Item registrado exitosamente");
    ...
    public responseDTO deleteInventory(Integer id) {
        ...
        if (inventory.isPresent()) {
            ...
            return new responseDTO("success", "Item eliminado exitosamente");

        } else {
            return new responseDTO("error", "Item no encontrado");
        }
    }
}