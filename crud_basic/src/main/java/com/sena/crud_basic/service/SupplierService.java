...
public class SupplierService {
    ...
    public responseDTO save(SupplierDTO supplierDTO) {
        ...
        return new responseDTO("Proveedor registrado correctamente");
    }
    ...
    public responseDTO deleteSupplier(int id) {
        if (!supplierRepository.existsById(id)) {
            return new responseDTO("El proveedor no existe");
        }
        supplierRepository.deleteById(id);
        return new responseDTO("Proveedor eliminado correctamente");
    }
